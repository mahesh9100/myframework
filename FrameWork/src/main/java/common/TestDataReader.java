...
public class TestDataReader {
	...
	/**
	 * Get the suitable test data file by providing the file name along with its
	 * location
	 * 
	 * @param fileNameWithPath
	 *            Provide the file name with exact location which holds the test
	 *            data for required test script
	 * @author mathuja@pickme.lk
	 * @return 
	 * @throws MojoExecutionException 
	 */
	

	public static void getTestDataFile(String fileNameWithPath) throws MojoExecutionException {
	 ...
	 * 
	 * @param testDataKey:
	 *            This is a key which holds the value of test data
	 * @author mathuja@pickme.lk
	 * @return 
	 */
